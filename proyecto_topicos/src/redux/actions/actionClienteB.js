...
export const listarCliente = createAsyncThunk(
    ...
    async () => {
      try {
        const resp = await axios.get('http://localhost:12630/api/ClienteInstancia2/Lista');
        return resp.data;
      } catch (error) {
        return null;
      }
  ...
  export const agregarCliente = createAsyncThunk(
    ...
    async (data, { rejectWithValue }) => {
      try {
        const resp = await axios.post('http://localhost:12630/api/ClienteInstancia2/Guardar', data);
        return resp.data;
      } catch (error) {
        return rejectWithValue(`Error: ${error.message}`);
      }
  ...
  export const eliminarCliente = createAsyncThunk(
    ...
    async (id, { rejectWithValue }) => {
      try {
        const resp = await axios.delete(`http://localhost:12630/api/ClienteInstancia2/Eliminar?idCliente=${id}`);
        return resp.data;
      } catch (error) {
        return rejectWithValue(`Error: ${error.message}`);
      }
  ...
  export const editarCliente = createAsyncThunk(
    ...
    async (data, { rejectWithValue }) => {
      try {
        const resp = await axios.put('http://localhost:12630/api/ClienteInstancia2/Editar', data);
        return resp.data;
      } catch (error) {
        return rejectWithValue(`Error: ${error.message}`);
      }
